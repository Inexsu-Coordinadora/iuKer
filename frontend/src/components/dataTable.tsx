  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-light text-gray-800 text-center mb-6">
            {title}
          </h1>
        ...
        {/* Tabla */}
        <div 
          className="bg-white rounded-lg border-2 overflow-hidden shadow-sm"
          style={{ borderColor: primaryColor }}
        >
          {loading ? (
                  ...
                  {data.length === 0 ? (
                    ...
                    data.map((cita, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm text-gray-700">
                          {cita.tipoDocPaciente}
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-700">
                          {cita.numeroDocPaciente}
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-700">
                          {cita.medico}
                        </td>
